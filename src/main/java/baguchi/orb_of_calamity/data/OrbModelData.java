...
public class OrbModelData extends ModelProvider {
    private final PackOutput.PathProvider blockStatePathProvider;
    private final PackOutput.PathProvider itemInfoPathProvider;
    private final PackOutput.PathProvider modelPathProvider;

    public OrbModelData(PackOutput packOutput) {
        super(packOutput, OrbOfCalamity.MODID);
    ...
    public CompletableFuture<?> run(CachedOutput output) {
        ...
        this.registerModels(new OrbBlockModelGenerators(blockModelOutput, itemModelOutput, modelOutput), new OrbItemModelGenerators(itemModelOutput, modelOutput));
